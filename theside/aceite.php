...
<html lang="en">
    <head>
        <!--=============== basic  ===============-->
        <meta charset="UTF-8">
        <title>Ruta 12 - Aceite Desgomado</title>
            ...
            <header class="main-header">
                ...
                <div class="left-panel_social">
                    <ul class="panelgranos" id="parent-list-b">
                        ...
                        <li id="d"><img src="images/iconos/atencion-gris.png" class="iconoslateral"></a></li>
                    </ul>
                </div>
                    ...
                    <div class="nav-holder but-hol">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="aceite.php" class="act-link">Aceite desgomado</a></li>
                                        </ul>
                                        <!--level 2 end -->
                                    </li>
                                    <li>
                        ...
                        <div class="nav-social">
                            ...
                            <ul >
                                ...
                                <li><a href="https://api.whatsapp.com/send?phone=5493435620954"><i class="fab fa-whatsapp"></i></a></li>
                            </ul>
                        </div>
                        <!--nav-social end -->
                    </div>
                    ...
                    <div class="content">
                        ...
                        <section class="hero-section dark-bg"  data-scrollax-parent="true">
                            ...
                            <div class="hero-bg">
                                ...
                                <video autoplay muted loop class="videoindustria">
                                    <source src="images/Industria/aceite-video.mp4" type="video/mp4">
                                </video>
                                <div class="pr-bg"></div>
                            ...
                            <div class="container">
                                <div class="section-title fl-wrap first-tile_load">
                                    <h2>ACEITE DESGOMADO DE SOJA <br style="display:block;content: '';margin-top: -2%;"> <span class="cerouno">SOMOS EXPORTADORES</span> </h2>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="fixed-column fl-wrap">
                                                ...
                                                <div class="pr-title">
                                                    <span>Aceite desgomado de soja por metodo de Extrusión-Prensado</span>
                                                </div>
                                                <ul class="pr-list dark-bg">
                                                    <li><a href="public/pdf/Aceite-FT.pdf" target="_blank"><span id="ficha">FICHA TECNICA</span></a></li>
                                                </ul>
                                        ...
                                        <div class="col-md-8 first-tile_load">
                                            ...
                                            <div id="tabs-container" class="fl-wrap">
                                                ...
                                                <div id="tab-1" class="tab-content">
                                                            ...
                                                            <div class="single-slider fl-wrap">
                                                                <div class="swiper-container">
                                                                    <div class="swiper-wrapper lightgallery">
                                                                        <div class="swiper-slide hov_zoom"><img src="images/Industria/aceite01.jpg" alt=""><a href="images/Industria/aceite01.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                                                        <div class="swiper-slide hov_zoom"><img src="images/Industria/aceite02.jpg" alt=""><a href="images/Industria/aceite02.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                                                        <div class="swiper-slide hov_zoom"><img src="images/Industria/aceite03.jpg" alt=""><a href="images/Industria/aceite03.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <h3 class="pr-subtitle mar-top"> ACEITE DESGOMADO DE SOJA</h3>
                                                    <p>En Ruta 12 obtenemos aceite por el método de Extrusión-Prensado, para luego pasarlo por un proceso de desgomado, obteniendo así nuestro producto final.</p>
                                                    <p>El aceite crudo de soja no solo es utilizado para su refinación para su consumo directo sino también para la elaboración de otros productos de consumo masivo, tales como margarinas y grasas vegetales.</p>
                                                </div>
                                                <!-- tab-content end--> 
                                                <!-- tab-content--> 
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="footer-contacts footer-box fl-wrap">
                                            <ul>
                                                ...
                                                <li><span>CORREO:</span><a target="_blank" href="https://mail.google.com/mail/?view=cm&fs=1&to=administracion@ruta12.com">  ADMINISTRACION@RUTA12.COM</a></li>
                                                <li><span>UBICACIóN : </span><a href="contacts.html">KM 365, Hernández, Entre Ríos </a></li>
                                            </ul>
                                        </div>
                                        <!-- footer contacts end -->
                                        <a href="contacts.html"  class="ajax fc_button">Escribinos<i class="fal fa-envelope"></i></a>
                                    </div>
                                    <div class="col-md-4">
