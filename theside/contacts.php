                        ...
                        <div class="nav-scroll-bar-wrap fl-wrap">
                            ...
                            <nav class="nav-inner" id="menu">
                                <ul>
                                    ...
                                    <li><a href="contacts.php" class="act-link">Contacto</a></li>
                                </ul>
                            </nav>
                            <!-- nav end-->
                            <!--lang-links-->
                    ...
                    <div id="modal" class="modal">
                        <div class="_main">
                            <div class="_container">
                                <div class="_title">
                                    <h3 style="font-size: 22px;">Consulta envida</h3>
                                </div>
                                <hr/>
                                <div class="_content">
                                    <p style="font-size: 18px; color: green;">Su consulta fue enviada a la gente de ruta12 de manera exitosa. Pronto se pondran en contacto con usted</p>
                                </div>
                                <div class="_footer">
                                    <hr/>
                        ...
                        <div class="fixed-column-wrap">
                            ...
                            <div class="fixed-column-wrap-content map-mobile">
                                ...
                                <div class="map-container mc_big">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d53959.57431393377!2d-60.068800535351556!3d-32.29913336631057!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x2ec9388f2321edb7!2zMzLCsDE3JzU5LjEiUyA2MMKwMDInNTEuNCJX!5e0!3m2!1ses-419!2sar!4v1660630064591!5m2!1ses-419!2sar" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                </div>
                            </div>
                                ...
                                <section id="sec1" class="small-padding">
                                    <div class="container">
                                        <div class="split-sceen-content_title fl-wrap">
                                            <div class="pr-bg pr-bg-white"></div>
                                            <h3> Consultas</h3>
                                            <p>Dejanos tu consulta,un asesor se comunicará con vos.🙂<br> Gracias por tu visita!  </p>
                                        </div>
                                                    ...
                                                    <div class="single-slider fl-wrap">
                                                        <div class="swiper-container swiper-container-horizontal swiper-container-autoheight" style="cursor: grab;">
                                                            <div class="swiper-wrapper lightgallery" style="transition-duration: 0ms; transform: translate3d(-621px, 0px, 0px); height: 411px;"><div class="swiper-slide hov_zoom swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="2" style="width: 621px;"><img src="images/industria/expeller03.jpg" alt=""><a href="images/industria/expeller03.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                                                <div class="swiper-slide hov_zoom swiper-slide-active" data-swiper-slide-index="0" style="width: 621px;"><img src="images/Consultas/consulta01.jpg" alt=""><a href="iimages/Consultas/consulta01.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                                                <div class="swiper-slide hov_zoom swiper-slide-next" data-swiper-slide-index="1" style="width: 621px;"><img src="images/Consultas/consulta02.jpg" alt=""><a href="images/Consultas/consulta02.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                                                <div class="swiper-slide hov_zoom swiper-slide-duplicate-prev" data-swiper-slide-index="2" style="width: 621px;"><img src="images/Consultas/consulta03.jpg" alt=""><a href="images/Consultas/consulta03.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a></div>
                                            ...
                                            <form  class="custom-form" action="php/contact.php" name="contactform" id="contactform">
                                                <fieldset>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text"  name="phone" id="phone" placeholder="Whatsapp *" value=""/>
                                                        </div>
                                                        <div class="col-md-6">
                                                    ...
                                                    <textarea name="comments"  id="comments" cols="40" rows="3" placeholder="Mensaje..."></textarea>
                                                    <div class="verify-wrap">
                                                        <span class="verify-text"> Cuanto es 2+5 ?</span>
                                                    ...
                                                    <div id="spinner_personal" style="display: none" class="spinner"></div>
                                                </fieldset>
                                            </form>
                                        </div>
                                        <!-- contact form  end-->
