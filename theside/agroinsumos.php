...
<html lang="en">
    <head>
        <!--=============== basic  ===============-->
        <meta charset="UTF-8">
        <title>Ruta 12 - Agroinsumos</title>
                        ...
                        <div class="nav-scroll-bar-wrap fl-wrap">
                            ...
                            <nav class="nav-inner" id="menu">
                                <ul>
                                    ...
                                    <li><a href="agroinsumos.php" class="act-link">Agroinsumos</a></li>
          ...
          <!--                   <div class="logoapibox">
                    ...
                    <div class="fixed-filter-panel bot-element fw-panel hor-mob-filter">
                        ...
                        <div class="fixed-filter-panel_title color-bg hor-mob-filter_btn">
                            Agroinsumos <i class="fal fa-long-arrow"></i>
                        </div>
                        <div class="gallery-filters">
                            <a href="#" class="gallery-filter " data-filter=".semillas">SEMILLAS</a>
                            <a href="#" class="gallery-filter " data-filter=".herbicidas">HERBICIDAS</a>
                            <a href="#" class="gallery-filter" data-filter=".fungicidas">FUNGICIDAS</a>
                            <a href="#" class="gallery-filter" data-filter=".coadyuvantes">COADYUVANTES</a>
                            <a href="#" class="gallery-filter" data-filter=".foliares">F. FOLIARES</a>
                            <a href="#" class="gallery-filter" data-filter=".acondicionadores">ACONDICIONADORES</a>
                    ...
                    <div class="horizontal-grid-wrap  fl-wrap  ">
                        ...
                        <div   id="portfolio_horizontal_container" class="two-ver-columns">
                            <!-- portfolio_item-->
                            <div class="portfolio_item acondicionadores">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/01.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="pr-bg"></div>
                            ...
                            <div class="portfolio_item acondicionadores">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/02.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                            ...
                            <div class="portfolio_item acondicionadores">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/03.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                            ...
                            <!-- portfolio_item end-->
                            <!-- portfolio_item-->
                            <div class="portfolio_item foliares">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/04.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                            ...
                            <!-- portfolio_item end-->
                            <!-- portfolio_item-->
                            <div class="portfolio_item semillas">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/05.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                            ...
                            <div class="portfolio_item semillas">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/06.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                            ...
                            <div class="portfolio_item semillas">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/07.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                            ...
                            <!-- portfolio_item end-->
                            <!-- portfolio_item-->
                            <div class="portfolio_item fungicidas">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/08.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                            ...
                            <!-- portfolio_item end-->
                            <!-- portfolio_item-->
                            <div class="portfolio_item coadyuvantes">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/09.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                            ...
                            <!-- portfolio_item end-->
                            <!-- portfolio_item-->
                            <div class="portfolio_item herbicidas">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/10.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                            ...
                            <div class="portfolio_item fungicidas">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/11.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                            ...
                            <div class="portfolio_item coadyuvantes">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/12.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                            ...
                            <div class="portfolio_item foliares">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/13.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                            ...
                            <div class="portfolio_item fungicidas">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/14.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                            ...
                            <div class="portfolio_item coadyuvantes">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/15.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                            ...
                            <div class="portfolio_item foliares">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/16.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                            ...
                            <div class="portfolio_item herbicidas">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/17.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
                            ...
                            <div class="portfolio_item herbicidas">
                                <div class="grid-item-holder">
                                    <img  src="images/agroinsumos/18.jpg"    alt="">
                                    <div class="grid-det">
                                        <div class="grid-det_category"><a href="#">Agroinsumos</a></div>
                                        <div class="grid-det-item">
                                            <a href="https://api.whatsapp.com/send?phone=5493435620954&text=Buenas, estoy necesitado asesoramiento" class=" grid-det_link">WhatsApp <i class="fal fa-long-arrow-right"></i></a>
