  ...
  <body class="collapsed-menu with-subleft">
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <ul class="br-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="position.php" class="nav-link">Position</a></li>
    ...
    <div class="br-subleft">
      ...
      <nav class="nav br-nav-mailbox flex-column">
        <a href="" class="nav-link"><i class="icon ion-person-stalker tx-16-force"></i> My Co-Workers</a>
        <a href="" class="nav-link"><i class="icon ion-person-stalker tx-16-force"></i> Family</a>
        <a href="" class="nav-link"><i class="icon ion-person-stalker tx-16-force"></i> Friends</a>
        <a href="" class="nav-link"><i class="icon ion-person-stalker tx-16-force"></i> Others</a>
      </nav>
    </div><!-- br-subleft -->
    ...
    <div class="br-contentpanel">
      <div class="br-pageheader pd-y-15 pd-md-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <a class="breadcrumb-item" href="pages.php">Pages</a>
          <span class="breadcrumb-item active">Contacts Manager</span>
        </nav>
      </div><!-- br-pageheader -->

      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Contacts Manager</h4>
          ...
          <table class="table mg-b-0 table-contact">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    <img src="http://via.placeholder.com/280x280" class="wd-40 rounded-circle" alt="">
                    <div class="mg-l-15">
                      <div class="tx-inverse">K<?echo $_SESSION["usuario"]; ?></div>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    <img src="http://via.placeholder.com/280x280" class="wd-40 rounded-circle" alt="">
                    <div class="mg-l-15">
                      <div class="tx-inverse">Gorgonia Magalpok</div>
                      <span class="tx-12">you@themepixels.me</span>
                    </div>
                  </div>
                </td>
                <td class="valign-middle hidden-xs-down">+1 743 2423</td>
                <td class="valign-middle hidden-xs-down">$40,000</td>
                <td class="dropdown hidden-xs-down">
                  <a href="#" data-toggle="dropdown" class="btn pd-y-3 tx-gray-500 hover-info"><i class="icon ion-more"></i></a>
                  <div class="dropdown-menu dropdown-menu-right pd-10">
                    <nav class="nav nav-style-1 flex-column">
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    <img src="http://via.placeholder.com/280x280" class="wd-40 rounded-circle" alt="">
                    <div class="mg-l-15">
                      <div class="tx-inverse">Marilyn Tarter</div>
                      <span class="tx-12">mrilyn@themepixels.me</span>
                    </div>
                  </div>
                </td>
                <td class="valign-middle hidden-xs-down">+1 234 1211</td>
                <td class="valign-middle hidden-xs-down">$23,000</td>
                <td class="dropdown hidden-xs-down">
                  <a href="#" data-toggle="dropdown" class="btn pd-y-3 tx-gray-500 hover-info"><i class="icon ion-more"></i></a>
                  <div class="dropdown-menu dropdown-menu-right pd-10">
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    <img src="http://via.placeholder.com/280x280" class="wd-40 rounded-circle" alt="">
                    <div class="mg-l-15">
                      <div class="tx-inverse">Belinda Connor</div>
                      <span class="tx-12">klumaad@themepixels.me</span>
                    </div>
                  </div>
                </td>
                <td class="valign-middle hidden-xs-down">+1 234 2222</td>
                <td class="valign-middle hidden-xs-down">$23,000</td>
                <td class="dropdown hidden-xs-down">
                  <a href="#" data-toggle="dropdown" class="btn pd-y-3 tx-gray-500 hover-info"><i class="icon ion-more"></i></a>
                  <div class="dropdown-menu dropdown-menu-right pd-10">
              ...
              <tr>
                ...
                <td class="valign-middle hidden-xs-down">+1 111 6789</td>
                <td class="valign-middle hidden-xs-down">$23,000</td>
                <td class="dropdown hidden-xs-down">
                  <a href="#" data-toggle="dropdown" class="btn pd-y-3 tx-gray-500 hover-info"><i class="icon ion-more"></i></a>
                  <div class="dropdown-menu dropdown-menu-right pd-10">
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    <img src="http://via.placeholder.com/280x280" class="wd-40 rounded-circle" alt="">
                    <div class="mg-l-15">
                      <div class="tx-inverse"><?echo $_SESSION["usuario"]; ?></div>
                      <span class="tx-12">klumaad@themepixels.me</span>
                    </div>
                  </div>
                </td>
