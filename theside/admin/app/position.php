...
<html lang="en">
  <head>
    ...
    <title>Position Utilities - Bracket Responsive Bootstrap 4 Admin Template</title>
  ...
  <body>
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <a href="card-dashboard.php" class="br-menu-link">
          <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="navigation.php" class="nav-link">Basic Nav</a></li>
          <li class="nav-item"><a href="navigation-layouts.php" class="nav-link">Nav Layouts</a></li>
        </ul>
        <a href="#" class="br-menu-link">
          <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="chart-chartist.php" class="nav-link">Chartist</a></li>
          <li class="nav-item"><a href="chart-sparkline.php" class="nav-link">Sparkline</a></li>
          <li class="nav-item"><a href="chart-peity.php" class="nav-link">Peity</a></li>
        </ul>
        <a href="#" class="br-menu-link">
          <div class="br-menu-item">
        ...
        <ul class="br-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="form-editor-code.php" class="nav-link">Code Editor</a></li>
        ...
        <ul class="br-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="map-leaflet.php" class="nav-link">Leaflet Maps</a></li>
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="background.php" class="nav-link">Background</a></li>
          <li class="nav-item"><a href="border.php" class="nav-link">Border</a></li>
          <li class="nav-item"><a href="height.php" class="nav-link">Height</a></li>
          <li class="nav-item"><a href="margin.php" class="nav-link">Margin</a></li>
          <li class="nav-item"><a href="padding.php" class="nav-link">Padding</a></li>
          <li class="nav-item"><a href="position.php" class="nav-link active">Position</a></li>
          <li class="nav-item"><a href="typography-util.php" class="nav-link">Typography</a></li>
          <li class="nav-item"><a href="width.php" class="nav-link">Width</a></li>
        </ul>
        <a href="pages.php" class="br-menu-link">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-ios-paper-outline tx-22"></i>
            <span class="menu-item-label">Apps &amp; Pages</span>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        <a href="layouts.php" class="br-menu-link">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-ios-book-outline tx-22"></i>
            <span class="menu-item-label">Layouts</span>
          </div><!-- menu-item -->
        </a><!-- br-menu-link -->
        <a href="sitemap.php" class="br-menu-link">
          <div class="br-menu-item">
        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name hidden-md-down"><?echo $_SESSION["usuario"]; ?></span>
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                ...
                <li><a href="index.php?logout=1"><i class="icon ion-power"></i> Sign Out</a></li>
              </ul>
            </div><!-- dropdown-menu -->
          </div><!-- dropdown -->
        </nav>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          <a class="breadcrumb-item" href="index.php">Bracket</a>
          <a class="breadcrumb-item" href="#">Utilities</a>
          <span class="breadcrumb-item active">Position Utilities</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Position Utilities</h4>
        <p class="mg-b-0">Use position utilities to quickly set a position of an element.</p>
      </div>

      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Setting a Position</h6>
          <p class="mg-b-25 mg-lg-b-50">You can set a position to an element instantly by using the following utilities classes.</p>
          ...
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-t-80 mg-b-10">Top, Right, Bottom &amp; Left Positioning</h6>
          <p class="mg-b-25 mg-lg-b-50">You can set a top,right,bottom and left position to an element using the following utilities classes.</p>

          <p class="tx-11 tx-uppercase tx-spacing-2 mg-t-40 mg-b-10 tx-gray-600">Sample Code</p>
          <pre><code class="html pd-20">&lt;div class="pos-absolute t-20 r-0"&gt;&lt;/div&gt;</code></pre>
          ...
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-t-80 mg-b-10">X and Y Positioning</h6>
          <p class="mg-b-25 mg-lg-b-50">You can set a top and bottom (y) and left and right (x) or even all (a) position to an element using the following utilities classes.</p>
          ...
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-t-80 mg-b-10">Negative Positioning</h6>
          <p class="mg-b-25 mg-lg-b-50">You can set a negative positioning to an element using the following utilities classes.</p>
          ...
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-t-80 mg-b-10">Z-Index Positioning</h6>
          <p class="mg-b-25 mg-lg-b-50">You can set a z-index to an element instantly using the following utilities classes.</p>
